...
class OrderServiceTest {
    ...
    @Mock
    private KafkaTemplate<String, com.fooddelivery.order.event.OrderEvent> kafkaTemplate;
    ...
    void testPlaceOrder_Success() {
        ...
        // Note: This test would need more setup for the full flow
        // Including order items repository mocking
    }
}
